...
export default function PolitiqueConfidentialitePage() {
  return (
    <LegalLayout title="Politique de confidentialité" lastUpdated="31 mai 2026" sections={SECTIONS}>
      ...
      <ul>
        <li>
          <strong>Société :</strong> NJTECH Solution
        </li>
        <li>
        ...
        <li>
          <strong>Adresse :</strong> {formattedAddress}
        </li>
        <li>
          <strong>Téléphone :</strong> {contact.phone.switchboard}
        </li>
        <li>
          <strong>Email :</strong> <a href={mailtoHref}>{contact.email}</a>
        </li>
        <li>
          <strong>Contact RGPD / DPO :</strong> [À COMPLÉTER — ex. rgpd@njtech.fr si DPO désigné]
        </li>
      </ul>

      <h2 id="donnees">Données collectées</h2>
      <p>
        Dans le cadre de l'utilisation du site, NJTECH Solution est susceptible de collecter les
        données suivantes :
      </p>
      ...
      <ul>
        ...
        <li>
          Données de cookies (voir notre <a href="/politique-cookies">Politique de cookies</a>)
        </li>
      </ul>
      <p>
        Le site NJTECH Solution n'effectue aucune collecte de données sensibles au sens de l'article
        9 du RGPD.
      </p>
      ...
      <ul>
        <li>
          <strong>Hébergeur du site :</strong> [À COMPLÉTER — ex. Vercel Inc.] — hébergement et
          infrastructure
        </li>
        <li>
          <strong>Service de messagerie :</strong> [À COMPLÉTER] — traitement des emails entrants
        </li>
        <li>
          <strong>Outil analytics :</strong> [À COMPLÉTER si applicable] — mesure d'audience
        </li>
      </ul>
      <p>
        NJTECH Solution ne vend ni ne loue vos données personnelles à des tiers. Vos données ne sont
        transmises à aucun partenaire commercial sans votre consentement explicite, sauf obligation
        légale.
      </p>

      <h2 id="transferts">Transferts hors Union européenne</h2>
      <p>
        Certains sous-traitants peuvent être établis hors de l'Union européenne (notamment aux
        États-Unis). Dans ce cas, NJTECH Solution s'assure que ces transferts bénéficient de
        garanties appropriées, notamment :
      </p>
      <ul>
      ...
      <p>
        [À COMPLÉTER — préciser les sous-traitants concernés et les garanties effectivement mises en
        place]
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          structuré et lisible par machine (applicable aux traitements fondés sur le consentement ou
      ...
      <p>
        ...
        <a href={mailtoHref}>{contact.email}</a> en indiquant votre nom, prénom et, si possible,
        votre email de contact.
      </p>
      <p>
        Nous nous engageons à répondre dans un délai d'<strong>un mois</strong> à compter de la
        réception de votre demande (délai pouvant être prolongé à trois mois en cas de demande
        complexe, avec information préalable).
      </p>
      <p>
      ...
      <p>
        Le site utilise des cookies. Pour en savoir plus sur les cookies utilisés, leur finalité et
        comment les paramétrer, consultez notre{" "}
      ...
      <p>
        ...
        notamment pour se conformer à l'évolution de la réglementation ou à de nouveaux traitements.
        La date de « dernière mise à jour » en haut de cette page sera actualisée en conséquence.
      </p>
