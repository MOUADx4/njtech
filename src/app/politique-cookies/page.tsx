...
export default function PolitiqueCookiesPage() {
  return (
    <LegalLayout title="Politique de cookies" lastUpdated="31 mai 2026" sections={SECTIONS}>
      <div className="note">
      ...
      <p>
        Les cookies peuvent être déposés par le site visité (<em>cookies first-party</em>) ou par
        des services tiers (<em>cookies third-party</em>). Certains cookies sont
        <strong> strictement nécessaires</strong> au fonctionnement du site ; d'autres nécessitent
      ...
      <table>
        ...
        <tbody>
          <tr>
            <td>
              <code>njtech-cookie-consent</code>
            </td>
      ...
      <p>
        Ces cookies permettent d'analyser le trafic et l'utilisation du site afin d'en améliorer les
        performances et le contenu. Ils ne sont activés qu'après votre accord explicite.
      </p>
      <table>
        <thead>
          <tr>
      ...
      <div className="note">Si aucun outil d'analyse n'est utilisé, supprimez cette section.</div>

      <h2 id="duree">Durée de vie des cookies</h2>
      <p>
        Conformément aux recommandations de la CNIL, la durée de vie maximale des cookies soumis à
        consentement est de <strong>13 mois</strong> à compter de leur dépôt. À l'issue de ce délai,
        votre consentement est de nouveau sollicité.
      </p>
      <p>
        Votre choix (accepter ou refuser) est mémorisé pendant <strong>6 mois</strong> via le cookie{" "}
        <code>njtech-cookie-consent</code>. Passé ce délai, la bannière réapparaît.
      </p>
      ...
      <ul>
        <li>
          <strong>Via la bannière du site :</strong> cliquez sur « Gérer mes cookies » dans le pied
          de page du site pour rouvrir le panneau de gestion.
        </li>
        <li>
          <strong>Via les paramètres de votre navigateur :</strong> la plupart des navigateurs
          permettent de bloquer ou supprimer les cookies. Cette action peut toutefois altérer le
      ...
      <p>
        Le site njtech-solution.fr n'intègre pas, à ce jour, de contenus embarqués de réseaux
        sociaux (boutons de partage, vidéos YouTube, etc.) susceptibles de déposer des cookies tiers
        sans votre consentement préalable.
      </p>
      <p>
        [À COMPLÉTER — si des widgets tiers sont intégrés, les lister ici avec leur politique de
        cookies respective]
      </p>
      ...
      <p>
        ...
        contactez-nous à : <a href={mailtoHref}>{contact.email}</a>.
      </p>
      <p>
        Pour en savoir plus sur vos droits, consultez notre{" "}
        <a href="/politique-de-confidentialite">Politique de confidentialité</a> ou le site de la
        CNIL :{" "}
        <a
