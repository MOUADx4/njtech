    ...
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[#020816] text-white">
      ...
      <Container className="relative z-10 flex flex-col items-center text-center">
        ...
        <div className="-mt-[clamp(5rem,12vw,10rem)] flex flex-col items-center">
          ...
          {/* Sub */}
          <p className="mt-5 max-w-md text-base md:text-lead leading-[1.75] text-white/60">
            ...
            <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
              {links.map((l) => (
                <Link
                  key={l.href}
                  href={l.href}
                  className="group flex items-center justify-center gap-1.5 rounded-lg border border-white/[0.07] bg-white/[0.03] px-4 py-3 text-body font-medium text-white/60 transition-all duration-300 hover:border-signal-500/25 hover:bg-white/[0.07] hover:text-white"
                >
