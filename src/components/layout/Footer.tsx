    ...
    <footer className="relative overflow-hidden bg-[#020912] text-white">
      ...
      <Container className="relative">
        ...
        <div className="grid grid-cols-1 gap-12 py-16 sm:grid-cols-2 lg:grid-cols-12">
            ...
            <div className="mt-7 space-y-2">
              {trustBadges.map((b) => (
                <div key={b.label} className="flex items-center gap-2.5">
                  ...
                  <span className="text-[0.72rem] font-medium text-white/55">{b.label}</span>
                </div>
              ))}
            </div>
          ...
          {/* Contact */}
          <div className="lg:col-span-3">
            <h3 className="mb-5 text-[0.6rem] font-bold uppercase tracking-[0.26em] text-white/55">
              Contact
            </h3>
            <div className="space-y-3.5">
              <div className="flex items-start gap-3 text-[0.8rem] leading-snug text-white/55">
        ...
        <div className="border-t border-white/[0.06] py-8">
          <p className="mb-6 text-[0.58rem] font-bold uppercase tracking-[0.28em] text-white/50">
      ...
      <div className="border-t border-white/[0.05]">
        <Container className="flex flex-col items-start justify-between gap-2 py-5 text-[0.68rem] text-white/55 md:flex-row md:items-center">
